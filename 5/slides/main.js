document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            ...
            { name: '🔍 Cap. 1: Network Discovery & Fingerprinting', start: 2, end: 9 },
            { name: '📋 Cap. 2: WordPress Enumeration', start: 10, end: 17 },
            { name: '🎯 Cap. 3: Vulnerability Assessment & Triage', start: 18, end: 23 },
            { name: '💥 Cap. 4: Exploitation', start: 24, end: 31 },
            { name: '🔓 Cap. 5: Post-Exploitation', start: 32, end: 36 },
            { name: '📝 Cap. 6: Reporting & Remediation', start: 37, end: 40 }
        ];
