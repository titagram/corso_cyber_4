document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: '📖 Introduzione e Teoria', start: 1, end: 3 },
            { name: '🔍 Reconnaissance', start: 4, end: 5 },
            { name: '🛠️ Preparazione Infrastruttura', start: 6, end: 8 },
            { name: '💥 Attacco e Post-Exploitation', start: 9, end: 11 },
            { name: '🛡️ Difesa e Conclusioni', start: 12, end: 15 }
        ];
