document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: '📖 Introduzione', start: 1, end: 1 },
            { name: '🔒 Modulo 1: Security Assessments', start: 2, end: 5 },
            { name: '📋 Modulo 2: Metodologia e Terminologia', start: 6, end: 9 },
            { name: '📐 Modulo 3: Standard e Compliance', start: 10, end: 11 },
            { name: '📊 Modulo 4: CVSS, CVE e OVAL', start: 12, end: 16 },
            { name: '🔷 Modulo 5: Nessus', start: 17, end: 24 },
            { name: '🟢 Modulo 6: OpenVAS', start: 25, end: 30 },
            { name: '📝 Modulo 7: Reporting', start: 31, end: 31 }
        ];
