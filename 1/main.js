document.addEventListener('DOMContentLoaded', () => {
    ...
    function showSlideIndex() {
        const chapters = [
            { name: '🛡️ Mindset & Design (Defense in Depth)', start: 1, end: 1 },
            { name: '🔍 Input Validation (Whitelist vs Blacklist)', start: 2, end: 2 },
            { name: '🎨 Output Encoding (XSS Prevention)', start: 3, end: 3 },
            { name: '🗄️ Database Security (Prepared Statements)', start: 4, end: 4 },
            { name: '🔐 Auth & Session Management', start: 5, end: 5 },
            { name: '🚫 Access Control (IDOR Prevention)', start: 6, end: 6 },
            { name: '⚠️ Error Handling & Logging', start: 7, end: 7 },
            { name: '📦 Supply Chain Security (Dependencies)', start: 8, end: 8 },
            { name: '🔬 Security Testing & Validation', start: 9, end: 9 },
            { name: '🔒 Security Headers & Hardening', start: 10, end: 10 },
            { name: '🚨 Incident Response & Monitoring', start: 11, end: 11 }
        ];
